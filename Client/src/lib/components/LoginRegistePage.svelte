  ...
  <div class="top">
    <div class="logo">
      <a href="https://github.com/"
        ><img class="img" src="\src\logo-placeholder-image.png" alt="" /></a
      >
    </div>
    <div class="links">
      <div class="link">
    ...
    <div class="gg">
      <div class="LRForm">
        ...
        <div class="input">
          <input
            id="password-input"
            placeholder={isLoggingIn ? "PASSWORD" : "MINIMUM 10 CHARACTERS"}
            type="password"
          />
        </div>
      </div>
      <div class="input">
        <button class="buttom" on:click={() => loginHandler()}>SUBMIT</button>
      </div>
      <div class="input">
        <button class="buttom" on:click={() => changeRegistrationMode()}
          >{isLoggingIn ? "REGISTER" : "LOGIN"}</button
        >
      </div>
    </div>
  </div>
